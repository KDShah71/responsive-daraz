      ...
      <div className="w-full bg-white">
        ...
        md:col-span-4
         flex mx-1 items-center"
            ...
            <div className="hidden   md:flex md:col-span-1 mx-auto">
              <div className="h-8 bg-gray-500   rounded-full flex justify-center items-center  ">
                <p className="text-sm px-10 font-bold text-white ">
                  GET Rs. 200 Off
                </p>
              </div>
            </div>
